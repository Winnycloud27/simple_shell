...
/**
 * get_command_type - gets command type
 *
 * @input: input string
...
/**
 * handle_alias_command - gets command type
 *
 * @clean_input: input string
 * @datash: the data structure
 */
...
/**
 * is_alias_exec_command - gets command type
 *
 * @clean_input: input string
 * @datash: the data structure
 * Return: -1 or 0
...
/**
 * free_string_array - Define a function to free a string array
 *
 * @arr: input string
 */
